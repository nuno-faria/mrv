...
public:
	...
	RC get_row(access_t type, txn_man *txn, row_t *&rowa, int escrow_column, double escrow_delta);
	void return_row(access_t type, txn_man * txn, row_t * row);
	void return_row_escrow(access_t type, txn_man *txn, Access *access, RC rc);
